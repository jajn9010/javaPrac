...
public class FileObjectSave {
	public static void main(String[] args) throws IOException {  //회원가입 창을 만듦
		String name = null;
		String id = null;
		String pwd = null;
		boolean gender = true;
		...
		try {
			FileOutputStream fos = new FileOutputStream(f, true);  //append mode  -->  true를 사용해서 기존의 내용을 남기는 것.
